...
// app.use(
//   cors({
//     origin: ["http://localhost:5173", "https://gamelingo-db.netlify.app"],
...
app.use((req, res, next) => {
  res.setHeader("Access-Control-Allow-Origin", "https://gamelingo-db.netlify.app");
...
app.post("/users", async (req, res) => {
  try {
    ...
    res.cookie("token", token, { maxAge: 60 * 60 * 1000, domain: "https://gamelingo-db.netlify.app/", path: "https://gamelingo-db.netlify.app/" });
